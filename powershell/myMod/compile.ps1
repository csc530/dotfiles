function compile() {
    ...
    New-Item -ItemType SymbolicLink -Path "$([Environment]::GetFolderPath('MyDocuments'))\PowerShell\Modules" -Value "$env:CONFIG_HOME\powershell\myMod" -Force -Name myMod | Out-Null
